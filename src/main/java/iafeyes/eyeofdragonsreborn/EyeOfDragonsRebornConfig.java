...
public class EyeOfDragonsRebornConfig {
    ...
    public static final EyeConfig POISON_DRAGON_EYE;

    static {
        ForgeConfigSpec.Builder builder = new ForgeConfigSpec.Builder();

        FIRE_DRAGON_EYE = new EyeConfig(builder, "fire_dragon_eye", "Fire Dragon Eye", false);
        ICE_DRAGON_EYE = new EyeConfig(builder, "ice_dragon_eye", "Ice Dragon Eye", false);
        LIGHTNING_DRAGON_EYE = new EyeConfig(builder, "lightning_dragon_eye", "Lightning Dragon Eye", false);
        POISON_DRAGON_EYE = new EyeConfig(builder, "poison_dragon_eye", "Poison Dragon Eye", true);
    ...
    public static class EyeConfig {
        ...
        public final ForgeConfigSpec.BooleanValue filterDeadDragons;
        public final ForgeConfigSpec.BooleanValue filterTamedDragons;
        public final ForgeConfigSpec.BooleanValue useStageWhitelist;
        public final ForgeConfigSpec.ConfigValue<List<? extends Integer>> stageList;

        public EyeConfig(ForgeConfigSpec.Builder builder, String path, String name, boolean requiresMod) {
            builder.comment("Settings for " + name + (requiresMod ? " (requires Poison Dragons mod to be installed)" : ""))
                   .push(path);
    ...
    public static EyeConfig getConfigForEye(ItemEyeBase eye) {
        if (eye instanceof ItemFireDragonEye) return FIRE_DRAGON_EYE;
        if (eye instanceof ItemIceDragonEye) return ICE_DRAGON_EYE;
        if (eye instanceof ItemLightningDragonEye) return LIGHTNING_DRAGON_EYE;
        if (eye instanceof ItemPoisonDragonEye) return POISON_DRAGON_EYE;
        return FIRE_DRAGON_EYE;
    }
}